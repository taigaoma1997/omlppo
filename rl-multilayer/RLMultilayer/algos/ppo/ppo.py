...
import gym
import time
from RLMultilayer.algos.ppo.utils.logx import EpochLogger
from RLMultilayer.algos.ppo.utils.mpi_pytorch import setup_pytorch_for_mpi, sync_params, mpi_avg_grads
from RLMultilayer.algos.ppo.utils.mpi_tools import mpi_fork, mpi_avg, proc_id, mpi_statistics_scalar, num_procs
...
def ppo(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
    ...
    def update():
        ...
        logger.store(LossPi=pi_l_old, LossV=v_l_old.detach(),
                     KL=kl, Entropy=ent.detach(), ClipFrac=cf,
                     DeltaLossPi=(loss_pi.item() - pi_l_old),
                     DeltaLossV=(loss_v.item() - v_l_old.detach()))
            ...
            if terminal or epoch_ended:
                ...
                if terminal:
                    ...
                    if hasattr(env, 'layers') and hasattr(env, 'thicknesses'):
                        ...
                        if rank == 0:
                            print(env.layers,  env.thicknesses, 'Rewards:', r_temp)
